...
|------------------------------------------|---------------|--------------------|------------------|---------------|---------------------|-------------------------|----------------|-----------------|----------------------|-------------|---------------------|
| [MAMBA](#mamba)          | &check;           | &check;                   | &check;                          | &check;           | &check;                    | &cross;                     | &check;              | &check;               | &cross;                    | &check;         | &check;                   |
| [QPLEX](#qplex)               | &check;           | &check;                   | &check;                          | &check;           | &check;                    | &cross;                     | &check;              | &check;               | &cross;                    | &cross;         | &check;                   |
| [IQL](#iql)                  | &check;           | &check;                   | &check;                          | &check;           | &check;                    | &cross;                     | &check;              | &check;               | &check;                    | &cross;         | &check;                   |
| [VDN](#vdn)              | &check;           | &check;                   | &check;                          | &check;           | &check;                    | &cross;                     | &check;              | &check;               | &cross;                    | &cross;         | &check;                   |
| [QMIX](#qmix)          | &check;           | &check;                   | &check;                          | &check;           | &check;                    | &cross;                     | &check;              | &check;               | &cross;                    | &cross;         | &check;                   |
| [Follower](#follower)        | &check;           | &check;                   | &check;                          | &cross;           | &check;                    | &cross;                     | &check;              | &check;               | &check;                    | &cross;         | &check;                   |
| [MATS-LP](#mats-lp) | &check;           | &check;                   | &check;                          | &cross;           | &check;                    | &cross;                     | &check;              | &check;               | &check;                    | &check;         | &check;                   |
| [Switcher](#switcher)       | &check;           | &check;                   | &check;                          | &cross;           | &check;                    | &check;                     | &check;              | &check;               | &check;                    | &cross;         | &check;                   |
| [SCRIMP](#scrimp)             | &check;           | &check;                   | &cross;                          | &check;           | &cross;                    | &cross;                     | &cross;              | &check;               | &cross;                    | &cross;         | &cross;                   |
| [DCC](#dcc)                | &check;           | &check;                   | &check;                          | &check;           | &cross;                    | &cross;                     | &cross;              | &check;               | &cross;                    | &cross;         | &cross;                   |
| [LaCAM](#lacam)            | &cross;           | &cross;                   | &cross;                          | &check;           | &cross;                    | &cross;                     | -                | -                 | -                      | -           | -                     |
| [RHCR](#rhcr)                   | &cross;           | &cross;                   | &cross;                          | &cross;           | &check;                    | &cross;                     | -                | -                 | -                      | -           | -                     |
